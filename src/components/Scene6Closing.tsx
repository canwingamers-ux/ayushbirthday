...
export default function Scene6Closing({ friend, onComplete }: { friend: Friend, onComplete: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold tracking-tighter leading-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-white/90 to-white/50">
          Happy Birthday,
          <br/>
          {friend.name}
        </h1>
