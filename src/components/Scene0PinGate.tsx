  ...
  return (
    ...
    >
      <motion.div 
        ...
        className="w-full max-w-sm backdrop-blur-xl bg-white/10 p-8 rounded-3xl border border-white/20 shadow-2xl"
      >
        <div className="flex justify-center mb-6">
          {friend.pinPhoto ? (
            <div className="w-32 h-32 rounded-sm p-2 bg-white/10 backdrop-blur-sm border border-white/20 shadow-2xl relative">
        ...
        <h2 className="text-2xl font-semibold text-center mb-2 tracking-tight text-white">Enter PIN</h2>
        <p className="text-white/70 text-center text-sm mb-8">This experience is protected.</p>
