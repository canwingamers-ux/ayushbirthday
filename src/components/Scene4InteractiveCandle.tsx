...
export default function Scene4InteractiveCandle({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        >
          <h2 className="text-2xl font-medium mb-12 text-white/80">
            {candlesLit > 0 ? "Tap the candles to make a wish" : "Happy Birthday!"}
          </h2>
